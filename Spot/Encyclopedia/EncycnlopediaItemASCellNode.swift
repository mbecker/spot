//
//  EncycnlopediaItemASCellNode.swift
//  Spot
//
...
class EncycnlopediaItemASCellNode: ASCellNode {
    
    let _realm = try! Realm()
    
    let _realmEncyclopediaItem      : String
    let _realmEncyclopediaItemName  : String
    let _realmEncyclopediaDetail    : String
    let _realmEncyclopediaURL       : URL?
    ...
    init(key: String, name: String, detail: String, url: URL?){
        self._realmEncyclopediaItem     = key
        self._realmEncyclopediaItemName = name
        self._realmEncyclopediaDetail   = detail
        self._realmEncyclopediaURL      = url
    ...
    override func layoutSpecThatFits(_ constrainedSize: ASSizeRange) -> ASLayoutSpec {
        ...
        self._title.attributedText          = NSAttributedString(string: self._realmEncyclopediaItemName, attributes: self._titleAttributes)
    ...
    func loadImage() {
        ...
        if let url: URL = self._realmEncyclopediaURL {
            self._image.url = url
        } else {
...
extension EncycnlopediaItemASCellNode: ASNetworkImageNodeDelegate {
